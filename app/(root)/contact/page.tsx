		...
		<div className='max-w-6xl mx-auto'>
			...
			<div className='grid grid-cols-2 max-md:grid-cols-1 gap-4 mt-6'>
				<div className='flex flex-col'>
					<h1 className='text-4xl font-creteRound'>Contact Donni</h1>
					...
					<div className='mt-12 flex items-center gap-3'>
						...
						<p className='text-sm'>info@donni.uz</p>
					</div>

					<div className='flex items-center gap-3 mt-2'>
						<Phone className='w-4 h-4' />
						<p className='text-sm'>+998 99 888 77 66</p>
					</div>
				</div>
				...
				<div>
					...
					<div className='flex flex-col space-y-3'>
						<Textarea
							...
							placeholder='Ask questions or just say Hi'
						/>
